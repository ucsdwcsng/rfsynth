...
def main() -> int:
    ...
    parser.add_argument("config_dir", nargs="?", default="/tmp/rfsynth_nr5g_matrix/configs")
    parser.add_argument("--out", default="/tmp/rfsynth_nr5g_matrix_raw_compare")
    ...
    if not args.use_existing_matlab:
        run_matlab_folder(config_dir, matlab_out_dir, Path(args.matlab), args.seed)
