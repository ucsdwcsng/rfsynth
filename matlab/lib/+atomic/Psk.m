    ...
    methods
        function this = Psk(varargin)
            ...
            this@atomic.Signal( ...
                ...
                'modulation', report.Modulation.psk);
        ...
        function dataIQ = generateTransmission(this)
            ...
            y1 = pskmod(x, this.modOrder, phase_ini, 'gray');
    ...
    methods (Access = private)
        function updateModOrderReport(this, modOrder)
            ...
            switch modOrder
                ...
                case 8
                    this.requiredMetadata.setModulation(report.Modulation.psk8);
                case 16
                    this.requiredMetadata.setModulation(report.Modulation.psk16);
                case 32
                    this.requiredMetadata.setModulation(report.Modulation.psk32);
                otherwise
                    this.requiredMetadata.setModulation(report.Modulation.psk);
            end
        end
    end
end
